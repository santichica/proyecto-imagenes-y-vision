...
class SafeImageDataset(Dataset):
    ...
    """
    def __init__(self, folder_path, ext_filter=('.png', '.jpg', '.jpeg', '.webp')):
...
if __name__ == '__main__':
    ...
    REAL_IMG_DIR = os.path.join(data_processed, "images")
    GEN_IMG_DIR = os.path.join(data_processed, "augmented_images") # O la ruta de las sintetizadas
